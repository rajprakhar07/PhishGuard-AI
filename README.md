...
**1️⃣ Message Input** – where the user pastes a suspicious message  
![Analyzer Input](screenshots/analyzer_input.png)

**2️⃣ Detection Result** – shows risk score, highlighted keywords, and threat classification  
![Analyzer Result](screenshots/analyzer_result.png)

### Phishing Simulator

**1️⃣ Scenario Selection** – choose a scenario like Bank Account, Job Offer, etc.  
![Simulator Fields](screenshots/simulator_fields.png)

**2️⃣ Generated Phishing Message** – example message and explanation generated by AI  
![Simulator Generated Message](screenshots/simulator_generated.png)
